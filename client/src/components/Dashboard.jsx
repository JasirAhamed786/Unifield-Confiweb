      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
        ...
        >
          ...
          <div className="space-y-2">
            <p className="text-gray-600"><span className="font-medium">Location:</span> {weather.location || 'Fetching...'}</p>
            <p className="text-gray-600"><span className="font-medium">Temperature:</span> {weather.temperature ? `${weather.temperature}°C` : 'N/A'}</p>
            <p className="text-gray-600"><span className="font-medium">Condition:</span> {weather.condition || 'Sunny'}</p>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="space-y-3">
            <Link
              to="/crops"
              className="flex items-center bg-gradient-to-r from-primary to-primary/80 text-white px-4 py-3 rounded-lg hover:from-primary/90 hover:to-primary/70 transition-all duration-200 shadow-md hover:shadow-lg transform hover:-translate-y-0.5"
            >
            ...
            <Link
              to="/forum"
              className="flex items-center bg-gradient-to-r from-secondary to-secondary/80 text-white px-4 py-3 rounded-lg hover:from-secondary/90 hover:to-secondary/70 transition-all duration-200 shadow-md hover:shadow-lg transform hover:-translate-y-0.5"
            >
            ...
            <Link
              to="/profile"
              className="flex items-center bg-gradient-to-r from-accent to-accent/80 text-white px-4 py-3 rounded-lg hover:from-accent/90 hover:to-accent/70 transition-all duration-200 shadow-md hover:shadow-lg transform hover:-translate-y-0.5"
            >
